...
Include the Turnrail version, supported Codex combination, reproduction steps, and expected behavior. Use redacted examples and fixture accounts. Never attach access tokens, refresh tokens, Keychain exports, `auth.json`, or an unredacted routing registry to an issue or report.
