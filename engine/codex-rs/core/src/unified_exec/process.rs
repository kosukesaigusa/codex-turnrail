...
pub(crate) trait SpawnLifecycle: std::fmt::Debug + Send + Sync {
    /// Reports whether an intercepted command approval was declined during execution.
    fn approval_declined(&self) -> bool;
...
impl UnifiedExecProcess {
    ...
    pub(super) fn approval_declined(&self) -> bool {
        self.spawn_lifecycle
            .as_ref()
            .is_some_and(|lifecycle| lifecycle.approval_declined())
    }
