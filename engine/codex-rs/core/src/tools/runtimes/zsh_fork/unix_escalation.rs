...
pub(crate) struct PreparedUnifiedExecZshFork {
    ...
    pub(crate) approval_status: ExecApprovalStatus,
}
...
pub(crate) async fn prepare_unified_exec_zsh_fork(
    ...
    let approval_status = ExecApprovalStatus::new();
...
struct CoreShellActionProvider {
    approval_status: ExecApprovalStatus,
            ...
            Decision::Prompt => {
                    ...
                    .is_some()
                {
                    ...
                    let decision = self
                        ...
                        .await?;
                    self.approval_status.record(&decision);
                    match decision {
