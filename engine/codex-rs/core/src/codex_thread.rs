...
impl CodexThread {
    ...
    /// Returns the authentication manager fixed to this loaded thread runtime.
    pub fn auth_manager(&self) -> Arc<AuthManager> {
        self.session.services.auth_manager.clone()
    }
    ...
    /// Reads the live runtime state without waiting for app-server event projection.
