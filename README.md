...
1. [Download Codex Turnrail for macOS (Apple silicon)](https://github.com/kosukesaigusa/codex-turnrail/releases/download/v0.10.0/Codex-Turnrail-v0.10.0-macos-arm64.zip).
